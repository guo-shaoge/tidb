	...
	data := &basicCopRuntimeStats{
		...
		BasicRuntimeStats: BasicRuntimeStats{
			tiflashScanContext: TiFlashScanContext{
				totalDmfileScannedPacks:            summary.GetTiflashScanContext().GetDmfileScannedPacks(),
				totalDmfileSkippedPacks:            summary.GetTiflashScanContext().GetDmfileSkippedPacks(),
				totalDmfileScannedRows:             summary.GetTiflashScanContext().GetDmfileDataScannedRows(),
				totalDmfileSkippedRows:             summary.GetTiflashScanContext().GetDmfileDataSkippedRows(),
				totalDmfileRoughSetIndexLoadTimeMs: summary.GetTiflashScanContext().GetTotalDmfileRsLoadMs(),
				totalDmfileReadTimeMs:              summary.GetTiflashScanContext().GetTotalDmfileReadMs(),
				totalCreateSnapshotTimeMs:          summary.GetTiflashScanContext().GetTotalBuildSnapshotMs(),
