...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:eo4gcBDdbE4HCozYGHsrhrEvf5Mtj36yt52IrU7xF/U=",
        version = "v2.0.8-0.20240407071728-85550c6b2bcd",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MCfYSh3oZIkHjXf+H65LI1abtdnRh6zdNYPwYDSodms=",
        version = "v0.0.0-20240407053619-a173a08acd81",
    )
    go_repository(
