...
require (
	...
	github.com/AilinKid/substrait-go v0.0.0-20221017053606-8cca1dcb1e21
...
replace github.com/pingcap/tipb => github.com/xuhuaiyu/tipb v0.0.0-20221020093752-694937141f5d
