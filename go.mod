...
require (
	...
	github.com/tidbcloud/aws-shared-provider/pkg/tidbworker/client v0.0.0-20240401090521-ee40bb3394a4
	github.com/tikv/client-go/v2 v2.0.8-0.20240410080031-15f5f67f8a1f
