...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:kFti/6pmYL4hbhhvxpxp4yGgPF0ZAkH1vVO90TWSm8o=",
        version = "v2.0.8-0.20240318071007-fb2a7c7eaa3c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BiFQvT54X/UMNjqO/UXqp7IWl9bvIaOfNaraqdpo++g=",
        version = "v0.0.0-20240318054542-da3b6e381c9b",
    )
    go_repository(
