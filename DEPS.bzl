...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:f2/7+/VoLNQ5CFcPFmcKrTjKX54ULgh1jD4GjHjStwU=",
        version = "v2.0.8-0.20240313072148-c2ebf162437c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MCFZikng5U6nh+02on0V1kSzGaBgB/LbmkiZwndYoyw=",
        version = "v0.0.0-20240313070340-7d22c4f3950a",
    )
    go_repository(
